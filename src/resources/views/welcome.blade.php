                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100" src="{{ asset('assets/img/service-1.jpg') }}"img
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-6">
                <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    @if(session('success'))
                        <div class="alert alert-success text-white bg-success border-0">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('booking.store') }}">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-6">
                                <input type="text" name="name" class="form-control border-0" placeholder="Your Name" value="{{ old('name') }}" required style="height: 55px;">
                            </div>
                            <div class="col-12 col-sm-6">
                                <input type="email" name="email" class="form-control border-0" placeholder="Your Email" value="{{ old('email') }}" required style="height: 55px;">
                            </div>
                            <div class="col-12 col-sm-6">
                            ...
                            <div class="col-12 col-sm-6">
                                <input type="datetime-local" name="service_date" class="form-control border-0" value="{{ old('service_date') }}" required style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea name="request" class="form-control border-0" placeholder="Special Request" rows="3">{{ old('request') }}</textarea>
                            </div>
                            <div class="col-12">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="{{ asset('assets/img/team-1.jpg') }}"
